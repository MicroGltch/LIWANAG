    ...
    <div uk-sticky="start: 200; animation: uk-animation-slide-top; sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; cls-inactive: uk-navbar-transparent uk-light">
        ...
        <div class="uk-container" style="max-width:1360px !important;">
                <div uk-navbar>
                    ...
                    <div class="menu-div uk-navbar-left uk-hidden@s" style="margin-top: 10px; margin-bottom:10px;">
                    ...
                    <div class="logo-center-div uk-navbar-center">
                        <a class="logo-navbar uk-navbar-item uk-logo" href="index.php" style="margin-top: -20px;">
...
<div id="offcanvas-slide" uk-offcanvas="mode: slide; overlay: true">
    <div class="uk-offcanvas-bar">
        ...
        <ul class="uk-nav uk-nav-default uk-hidden@s">
            <?php if (isset($_SESSION['account_ID'])): ?>
                <li class="uk-active"><a href="<?php echo $dashboardURL; ?>" style="color:black; border-radius: 15px; margin-top:10px;">Dashboard</a></li>
                <li class="uk-active"><a href="Accounts/logout.php" style="color:black; border-radius: 15px;">Logout</a></li>
            <?php else: ?>
                <li class="uk-active"><a href="Accounts/signuppage.php" style="color:black; border-radius: 15px; margin-top:10px;">Sign Up</a></li>
