...
<head>
    ...
    <title>LIWANAG - EMAIL NOT SENT</title>
...
<body>
    ...
    <div class="uk-width-1@s uk-width-1@l">
        ...
        <div class="email-card uk-card uk-card-default uk-card-body uk-text-center">
            <span class="error-icon" uk-icon="icon: warning; ratio: 3"></span>
            <h3 class="uk-card-title">Email not found</h3>
            <p>The email address you entered is not registered in our system.</p>
        </div>
        </div>
    </div>
