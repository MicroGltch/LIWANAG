        ...
        <div class="uk-width-1-1 uk-width-1-5@m uk-background-default uk-padding uk-box-shadow-medium">
            ...
            <div class="sidebar-nav">
                <ul class="uk-nav uk-nav-default">
                    ...
                    <li><a href="accountdetailspage.php"><span class="uk-margin-small-right" uk-icon="user"></span> Account Details</a></li>
                    <li class="uk-active"><a href="settingspage.php"><span class="uk-margin-small-right" uk-icon="cog"></span> Settings</a></li>
                </ul>
            </div>
        </div>
