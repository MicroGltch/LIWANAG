...
<head>
    ...
    <title>LIWANAG - EMAIL SENT</title>
    ...
    <div class="uk-width-1@s uk-width-1@l">
        <div class="uk-flex uk-flex-center uk-flex-middle uk-height-viewport">
            <div class="email-card uk-card uk-card-default uk-card-body uk-text-center">
                <span class="success-icon" uk-icon="icon: check; ratio: 3"></span>
                <h3 class="uk-card-title">Email sent successfully!</h3>
                <p>Please check your email to find your OTP code.</p>
            </div>
        </div>
    </div>
