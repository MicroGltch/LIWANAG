            ...
            <form class="uk-form-stacked uk-grid-medium" uk-grid>
                ...
                <div class="uk-width-1@s uk-width-1-2@l ">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="text" placeholder="Input your First Name..." required>
                    </div>
                </div>
                ...
                <div class="uk-width-1@s uk-width-1-2@l">
                    ...
                    <div class="uk-form-controls">
                        <input  class="uk-input" id="form-stacked-text" type="text" placeholder="Input your Last Name..." required>
                    </div>
                </div>
                ...
                <div class="uk-width-1@s uk-width-1@l">
                    ...
                    <div class="uk-form-controls">
                        <input  class="uk-input" id="form-stacked-text" type="text" placeholder="Input your Email..." required>
                    </div>
                </div>
                ...
                <div class="uk-width-1@s uk-width-1@l">
                    ...
                    <div class="uk-form-controls">
                        <input  class="uk-input" id="form-stacked-text" type="text" placeholder="Input your Address..." required>
                    </div>
                </div>  
                ...
                <div class="uk-width-1@s uk-width-1@l">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input phonenumber-input" id="form-stacked-text" type="text" placeholder="Input your Phone Number..." required>
                    </div>
                </div> 

                <!-- Sign Up Button -->
                <div class="signup-btn-div uk-width-1@s uk-width-1@l">
                    <button class="uk-button uk-button-primary uk-width-1@s uk-width-1@l" onclick="return validatePassword() && validateMobileNumber()">Sign Up</button>
                </div>
