...
<head>
    ...
    <!-- SweetAlert2 Library - Place this before other scripts -->
    ...
    <?php
    session_start();
    // Check if we have status message from the process
    if(isset($_SESSION['status']) && isset($_SESSION['message'])) {
        $status = $_SESSION['status'];
        $message = $_SESSION['message'];
        
        // Clear the session variables after storing them locally
        $showAlert = true;
    } else {
        $showAlert = false;
    }
...
<body>
    ...
    <!-- SweetAlert Script - Directly inject the alert without relying on DOMContentLoaded -->
    <script>
