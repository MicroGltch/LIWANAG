<?php
 ...
 // EYES HEREEEEEEEEEEEEE
 // THIS IS FOR TIME TABLE CALENDAR IN CREATING AN APPOINTMENT
 // GET THERAPIST SLOT IS FOR UPDATING/INPUTTING NEW SCHED FOR EACH PATIENT
